...
def getTimeSeries(request):
    ...
    if serializer.is_valid():
        ...
        response = iHARPExecuterInstance.getTimeSeriesScript(variable,startDateTime,endDateTime,temporalLevel,north,east,south,west)
...
def getHeatMap(request):
    ...
    if serializer.is_valid():
        ...
        variable = request.data.get("variable")
        videoFile = iHARPExecuterInstance.getHeatMapScript(variable,startDateTime,endDateTime,temporalLevel,aggLevel,north,east,south,west)
